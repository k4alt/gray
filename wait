...
getgenv().DeathCheck = Rise.Aimbot.Checks.DeathCheck
getgenv().WallCheck = Rise.Aimbot.Checks.WallCheck -- Add this line
...
RService.RenderStepped:Connect(function()
    ...
    if Aimlock == true and MousePressed == true then 
        if AimlockTarget and AimlockTarget.Character and AimlockTarget.Character:FindFirstChild(getgenv().AimPart) then 
            ...
            if getgenv().WallCheck and CheckIfObstructed(AimlockTarget) then
                return -- Don't update if target is obstructed by a wall.
            end
