...
getgenv().Aiming = {
    ...
    ShowFOV = Rise.FOV.Visible,
    FOV = Rise.FOV.Radius,
    FOVSides = Rise.FOV.Sides,
    FOVColour = Rise.FOV.Color,

    VisibleCheck = Rise.Silent.Checks.VisibleCheck,
    
    HitChance = Rise.Silent.HitChance,

    Selected = nil,
    SelectedPart = nil,

    TargetPart = {Rise.Silent.Part},
